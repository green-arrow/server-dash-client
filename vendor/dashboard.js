import PackDash from './dashboard.packery';

var Dashboard = function (selector, options) {
    ...
    return {
        initialize: function (immediate) {
            ...
            $(selector).each(function () {
                ...
                self.packDash = new PackDash(container, localOptions).initialize(true);
        ...
        clone: function() {
            ...
            dashClone = new Dashboard(elClone);
